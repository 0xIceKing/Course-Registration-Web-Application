				...
				<div class="main-content">
								...
								<table class="table">
									<thead
										...
										<tr>
											...
											<th style="width: 6%">Số tín chỉ</th>
											<th style="width: 1%"></th>
											<th style="width: 5%"></th>
					...
					<div class="modal2">
						<div class="addSubject">
							...
							<form action="updateCurriculum?action='addSubjectForSemester'" method="POST">
					...
					<div class="modal1">
						<div class="confirmDelete">
							<form name="delete-form" action="deleteCurriculum" method="POST">
								...
								<div class="action">
									<button type="submit" id="btn-delete-user" class="btn">Đúng</button>
