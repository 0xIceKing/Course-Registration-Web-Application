				...
				<div class="main-content">
					<div class="form-container">
						<form id="formAddSinhVien" action="upDateStudent" method="POST">
							<div class="form-content">
								...
								<div class="form-group">
									<div class="classContent">
										<label for="MaLop">Mã Lớp :</label> <select id="MaLop"
											name="MaLop">
											<%
											...
											%>
											<option value="<%= (sinhVien != null ? sinhVien.getLop().getMaLop() : maLop) %>"
    										<%= (sinhVien != null && sinhVien.getLop() != null && lop.getMaLop().equals(sinhVien.getLop().getMaLop())) 
								...
								<div class="form-group">
									<div class="userContent">
										...
										<input type="text" id="User" name="User" value="<%= (sinhVien != null && sinhVien.getTaiKhoan() != null) ? sinhVien.getTaiKhoan().getUserName() : (taiKhoan != null ? taiKhoan : "") %>" required />
									</div>
								</div>
								<div class="form-group">
									<div class="passWordContent">
										<label for="Password">Mật khẩu:</label> 
										<input type="password" id="Password" name="Password" value="<%= (sinhVien != null && sinhVien.getTaiKhoan() != null) ? sinhVien.getTaiKhoan().getMatKhau() : (taiKhoan != null ? matKhau : "") %>" required />
							...
							<button class="addStudent" type="submit">Sửa Sinh Viên</button>
						</form>
					</div>
				</div>
			</div>
