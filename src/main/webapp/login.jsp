...
<link href="https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css"
	rel="stylesheet" />
<script src="handleJs/loginScript9.js"></script>
</head>
			...
			<div class="login_form">
				<form action="login" method="POST">
					...
					<div class="admin_login">
						<label><input type="checkbox" style="margin-right: 10px"
							name="admin" />Đăng nhập dưới quyền admin</label>
					</div>
					<%
				...
				<a href="#" class="forget_password">Sinh viên quên mật khẩu ?</a>
			</div>
		</div>
	</div>
</body>
