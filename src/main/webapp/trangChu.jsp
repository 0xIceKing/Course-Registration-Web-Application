	...
	<div class="infor-container" style="margin-top: 60px">
		<div class="news-container news">
			<div class="news-header">
				<h4 class="news-title">Tin tức</h4>
			</div>
			<div class="news-content">
				<ul class="news-list-items" >
					 <%for(LoaiThongBao ltb:dsLTB){%>
							<li class="news-item" onclick="changeTitle('<%=ltb.getTenLoaiThongBao()%>'); changeIframeSrc('./trangChu?hanhDong=a&loaiThongBao=<%=ltb.getMaLoaiThongBao()%>&trang=1');"><%=ltb.getTenLoaiThongBao()%></li>
						<hr>
					<%}%>																						
				</ul>
			</div>
		...
		<div class="news-container notice">
                <div class="news-header notice-header">
					<h4 class="news-title" id="title-announce">Thông báo nổi bật</h4>
